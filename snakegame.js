...
const foodSound = new Audio("Snake Game Sound1.mp3");
const gameOverSound = new Audio("snakegame-over-a.mp3");
const moveSound = new Audio("movesound.wav")
const musicSound = new Audio("snake music background.mp3");
let speed = 4;
let score = 0;
let lastPaintTime = 0;
let snakeArr = [
